...
func TestCreateUser(t *testing.T) {
	...
	if createdUser.ID == 0 {
		t.Error("want id not to be zero")
	}
	...
	if err == nil {
		t.Errorf("expected error no to be nil for invalid CreateUser sql")
	}
	...
	if err != nil {
		t.Errorf("expeceted nil error during DeleteUserByID; got %q", err)
	}
